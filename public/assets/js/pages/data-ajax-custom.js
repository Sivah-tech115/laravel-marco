$(document).ready(function() {
    setTimeout(function() {
        ...
        $('#dt-ajax-array').DataTable({
            "ajax": "../../plugins/data-tables/json/dt-json-data/arrays.txt"
        });
        // [ Ajax Data Source (Objects) ]
        $('#dt-ajax-object').DataTable({
            "ajax": "../../plugins/data-tables/json/dt-json-data/objects.txt",
            "columns": [{
                    "data": "name"
                },
                {
        ...
        $('#dt-nested-object').DataTable({
            "processing": true,
            "ajax": "../../plugins/data-tables/json/dt-json-data/objects_deep.txt",
            "columns": [{
                    "data": "name"
                },
                {
        ...
        $('#dt-orthogonal').DataTable({
            ajax: "../../plugins/data-tables/json/dt-json-data/orthogonal.txt",
            columns: [{
                    data: "name"
                },
                {
