    ...
    setTimeout(function() {
        ...
        function drawVisualization() {
            ...
            var options = {
                ...
                colors: ['#0A3354', '#463699', '#FF425C', '#FF9764', '#13bd8a','#2DCEE3']
            };
        ...
        function drawChartDonut() {
            ...
            var optionsDonut = {
                ...
                pieHole: 0.4,
                colors: ['#0A3354', '#463699', '#FF425C', '#FF9764', '#13bd8a']
            };
        ...
        function drawChartThreshold() {
            ...
            var optionsThreshold = {
                ...
                colors: ['#0A3354', '#463699', '#FF9764', '#13bd8a']
            };
