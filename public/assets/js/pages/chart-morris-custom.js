...
$(document).ready(function() {
    setTimeout(function() {
        ...
        Morris.Bar({
            ...
            barColors: ["#0A3354", "#463699", "#13bd8a"]
        });
        ...
        Morris.Bar({
            ...
            ykeys: ['a', 'b', 'c'],
            labels: ['Bar 1', 'Bar 2', 'Bar 3'],
            barColors: ["#FF9764", "#FF425C", "#0A3354"]
        });
        ...
        Morris.Area({
            ...
            lineColors: ['#FF425C', '#463699', '#0A3354'],
            xkey: 'period',
        ...
        var graph_real = Morris.Line({
            ...
            ymin: -1.0,
            ymax: 1.0,
            lineColors: ['#FF9764', '#FF425C', '#0A3354'],
            pointSize: 4,
            responsive: true,
            pointFillColors: ['#fff', '#fff', '#fff'],
            pointStrokeColors: ['#FF9764', '#FF425C', '#0A3354'],
            lineWidth: 2,
            hideHover: true
        });
