...
<section class="herobanner_sec overlay">
    <div class="container">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse tristique ullamcorper ex, vitae consequat nisl ultrices. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
    </div>
</section>
<section class="privacy_content_sec">
    <div class="container">
        <h4>Who we are</h4>
        <p><strong>Suggested text:</strong> Our website address is: <a href="https://negozishop.it">https://negozishop.it</a>. Marco Fioschini, via Taranto 27, 73010 Veglie (LE)</p>
        <h4>Comments</h4>
